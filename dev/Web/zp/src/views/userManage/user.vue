 ...
 * @Last Modified time: 2019-12-27 22:32:59
 */
<template>
  <div id="userList">用户列表页面
      {{ids}}
      <el-button @click="toAdd" size="mini" type="primary">添加用户</el-button>
      <div class="select">
     ...
     <div class="footerDiv">
      ...
      <!-- 导入用户模态框 -->
      <el-dialog title="导入求职者信息" :visible.sync="addVisible" :before-close="beforeClose"> 
         <el-form :model="addJober"  :rules="rules" ref="ruleForm">
           {{addJober}}---
           <el-row>
            <el-col :span="12"><el-form-item label="用户名" :label-width="formLabelWidth" placeholder="请输入用户名">
              <el-input v-model="addJober.username" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12"> <el-form-item label="联系方式" :label-width="formLabelWidth">
              <el-input v-model="addJober.telephone" ></el-input>
              </el-form-item>
            </el-col>
            </el-row>
            <el-row>
            <el-col :span="12"> <el-form-item label="真实姓名" :label-width="formLabelWidth">
              <el-input v-model="addJober.realname" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12"><el-form-item label="性别" :label-width="formLabelWidth">
              <el-input v-model="addJober.gender" ></el-input>
              </el-form-item> 
            </el-col>
            </el-row>
            <el-row>
            <el-col :span="12"> <el-form-item label="学历" :label-width="formLabelWidth">
            <el-input v-model="addJober.education" ></el-input>
            </el-form-item>
            </el-col>
            <el-col :span="12"> <el-form-item label="求职状态" :label-width="formLabelWidth">
            <el-input v-model="addJober.currentStatus" ></el-input>
            </el-form-item>
            </el-col>
            </el-row>
          <el-row>
            <el-col :span="12"> <el-form-item label="出生日期" :label-width="formLabelWidth">
              <el-input v-model="addJober.birth" ></el-input>
              </el-form-item>
          </el-col>
            <el-col :span="12"><el-form-item label="工作时间" :label-width="formLabelWidth">
            <el-input v-model="addJober.workTime" ></el-input>
          </el-form-item>
          </el-col>
          </el-row>
          <el-row>
            <el-col :span="12"><el-form-item label="简历" :label-width="formLabelWidth">
            <el-input v-model="addJober.resume" ></el-input>
           </el-form-item>
          </el-col>
            <el-col :span="12"><el-form-item label="密码" :label-width="formLabelWidth">
           <el-input v-model="addJober.password" ></el-input>
          </el-form-item>
          </el-col>
          </el-row>
        </el-form>
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="toSave">导入</el-button>
        </div>
      </el-dialog>
      <!-- 修改模态框 -->
